const work = [
...

    {
        ...
        role: "Data Engineer",
        summary: "I created user-friendly Python tools to extract and analyze location-based data, helping uncover hidden profit opportunities. By combining Python with QGIS, I was able to study and visually present client data alongside geo-spatial attributes, making complex information easy to understand. Through detailed statistical analysis, I estimated regional profitability, which has been incredibly useful for financial institutions, automobile companies, and real estate developers to make well-informed decisions."
    },
    {
        name: "Latlong (ONZE Technologies Pvt. Ltd.)",
